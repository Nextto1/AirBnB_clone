#!/usr/bin/python3
"""Unittest module use for the BaseModel Class."""
...
class TestBaseModel(unittest.TestCase):
    ...
    """The Test Cases use for the BaseModel class."""
    ...
    def test_3_init_no_args(self):
        """Tests __init__ that has no arguments."""
        self.resetStorage()
    ...
    def test_3_init_many_args(self):
        """Tests __init__ that has many arguments."""
        self.resetStorage()
    ...
    def test_3_attributes(self):
        """Tests attributes value used for instance of a BaseModel class."""
    ...
    def test_4_instantiation(self):
        """Tests instantiation that has **kwargs."""
    ...
    def test_4_instantiation_dict(self):
        """Tests instantiation that has **kwargs from custom dict."""
    ...
    def test_5_save_excess_args(self):
        """Tests that save() with too many arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
