...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests used for testing promps of the command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests useed for testing help messages of the command interpreter."""

    def test_help_quit(self):
        h = "Quit command use to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_create(self):
        h = ("Usage: create <class>\n        "
             "Creating a new class instance and printing its id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "Signal of EOF to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Showing of a class instance string representation of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_destroy(self):
        h = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
             "Remove a given id of a class instance.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("Usage: all or all <class> or <class>.all()\n        "
             "Showing all instances of a given class string representation"
             ".\n        In case no class is specified, show all instantiated "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        h = ("Usage: count <class> or <class>.count()\n        "
             "Retrieves a given class number of instances.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
             ...
             "Updating a given id class instance by adding up / updating\n   "
             "     a known attribute key or value pair or dictionary.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help(self):
        h = ("Documented commands (type help <topic>):\n"
             "========================================\n"
             "EOF of all  numbered  create  destroy  help  quit  show  update")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests used for testing exiting from the command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests used for testing create from the command interpreter."""
    ...
    def test_create_missing_class(self):
        correct = "** class name thats missing **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests used for testing show from the command interpreter"""
    ...
    def test_show_missing_id_space_notation(self):
        correct = "** instance id thats missing **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests use for testing destroy from the command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests use for testing all of the command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests use for testing update from the command interpreter."""
    ...
    def test_update_missing_attr_name_space_notation(self):
        correct = "** attribute name thats missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests use for testing count method of comand interpreter."""
